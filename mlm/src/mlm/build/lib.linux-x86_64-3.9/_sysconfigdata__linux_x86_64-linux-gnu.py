...
build_time_vars = {'ABIFLAGS': '',
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/content/drive/MyDrive/FakeNewsDetection/mlm/src/mlm/coverage.info',
 'COVERAGE_REPORT': '/content/drive/MyDrive/FakeNewsDetection/mlm/src/mlm/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. -IPython-3.9.0/Include',
 'CXX': 'g++ -pthread',
 ...
 'MAKESETUP': 'Python-3.9.0/Modules/makesetup',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g '
                             ...
                             '-Werror=implicit-function-declaration '
                             '-fvisibility=hidden  '
                             '-IPython-3.9.0/Include/internal -IObjects '
                             '-IInclude -IPython -I. -IPython-3.9.0/Include '
 ...
 'PY_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                     ...
                     '-Werror=implicit-function-declaration '
                     '-fvisibility=hidden  -IPython-3.9.0/Include/internal',
 'PY_COERCE_C_LOCALE': 1,
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   '-Wall -std=c99 -Wextra -Wno-unused-result '
                   '-Wno-unused-parameter -Wno-missing-field-initializers '
                   '-Werror=implicit-function-declaration -fvisibility=hidden  '
                   '-IPython-3.9.0/Include/internal -IObjects -IInclude '
                   '-IPython -I. -IPython-3.9.0/Include -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '',
 'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. -IPython-3.9.0/Include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '',
 'PY_LDFLAGS_NODIST': '',
 ...
 'SRC_GDB_HOOKS': 'Python-3.9.0/Tools/gdb/libpython.py',
 'STDC_HEADERS': 1,
 ...
 'TESTPYTHON': './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': './python Python-3.9.0/Tools/scripts/run_tests.py',
 'TESTTIMEOUT': 1200,
 'TIMEMODULE_LIB': 0,
 ...
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 'UPDATE_FILE': 'python3 Python-3.9.0/Tools/scripts/update_file.py',
 ...
 'abs_builddir': '/content/drive/MyDrive/FakeNewsDetection/mlm/src/mlm',
 'abs_srcdir': '/content/drive/MyDrive/FakeNewsDetection/mlm/src/mlm/Python-3.9.0',
